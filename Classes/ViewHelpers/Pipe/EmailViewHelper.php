...
class EmailViewHelper extends AbstractPipeViewHelper
{
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('recipient', 'string', 'Message recipient address or name+address as "Name <add@ress>"',
            true);
        $this->registerArgument('sender', 'string', 'Message sender address or name+address as "Name <add@ress>"',
            true);
    }
